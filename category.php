...
<section class="products">
   ...
   <?php
      $category = htmlspecialchars($_GET['category']); // sanitize input
   ?>
   <h1 class="heading"><?= ucfirst($category); ?> - Unikart</h1>
   ...
   <form action="" method="post" class="box">
      ...
      <!-- Price and Quantity -->
      <div class="flex">
         <div class="price">UGX <?= number_format($fetch_product['price']); ?>/-</div>
